...
public:
    ...
    Option(const Equity* E, const Equity* Risk_Free, double K, double T, string Type); //Option Class Constructor
    ...
    const Equity* GetUnderlying() const; // Getting the underlying asset of the Option
    const Equity* GetRFR() const; // Getting the risk-free equity object
...
private:
    const Equity* E_; // underlying asset of the option
    const Equity* Risk_Free_; // Risk free rate
